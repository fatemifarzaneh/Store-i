...
namespace ALLAH.Application.Services.Products.queries.GetProductDetailForSite
{
    ...
    public class GetProductDetailForSiteService : IGetProductDetailForSiteService
    {
        ...
        public ResultDto<ProductDetailForSiteDto> Execute(long Id)
        {
            var Product = _context.Products
                ...
                .Include(p=>p.ProductImagess)
                .Include(p=> p.ProductFeaturess)
            ...
            return new ResultDto<ProductDetailForSiteDto>()
            {
                Data = new ProductDetailForSiteDto
                {
                    ...
                    Price = Product.Price,
                    Title = Product.Name,
                    Images = Product.ProductImagess.Select(p => p.Src).ToList(),
                    Features = Product.ProductFeaturess.Select(p => new ProductDetailForSite_FeaturesDto
                    {
